	...
	router.post('/uploadSample', function (req, res) {
		upload(req, res, function (err) {
			try {
				...
				collection.insert({
					fieldName: req.file.fieldname, originalName: req.file.originalname, encoding: req.file.encoding, mimetype: req.file.mimetype,
					destination: req.file.location, fileName: req.file.filename, path: req.file.path, fileSize: req.file.size, bpm: Number(req.body.bpm), key: req.body.key,
					points: req.body.points, tagJson: req.body.tagJson, type: req.body.type, packname: req.body.packname,
				},
